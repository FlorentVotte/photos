              ...
              {reorderMode ? (
                <>
                  ...
                  <button
                    ...
                    className="group/cta inline-flex items-center gap-3 font-sans text-label uppercase text-foreground hover:text-foreground transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex items-center justify-end gap-8">
                        ...
                        <button
                          onClick={saveAlbum}
                          disabled={saving}
                          className="group/cta inline-flex items-center gap-3 font-sans text-label uppercase text-foreground hover:text-foreground transition-colors disabled:opacity-40"
                        >
                    ...
                    <div className="flex items-start gap-5">
                      {reorderMode && (
                        <div className="flex flex-col items-center gap-1">
                          ...
                          <span className="font-sans text-[0.75rem] tabular-nums text-text-muted">
                      ...
                      >
                        {album.coverImage ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <span className="font-sans text-[0.5625rem] uppercase tracking-[0.2em] text-text-muted">
                              No cover
                            </span>
                          </div>
                        )}
                        {!reorderMode && (
                          <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                            <span className="font-sans text-[0.5625rem] uppercase tracking-[0.2em] text-foreground">
                              Change
                            </span>
                          </div>
                        )}
                      ...
                      <div className="flex min-w-0 flex-1 flex-col gap-2">
                        <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                          ...
                          {album.featured && (
                            <span className="font-sans text-micro uppercase text-foreground/80">
                              Featured
                            </span>
                          )}
                        </div>
                      ...
                      >
                        ...
                        {isCurrentCover && (
                          <div className="absolute inset-0 bg-background-dark/50 flex items-center justify-center">
                            <span className="font-sans text-micro uppercase text-foreground">
                              Current
                            </span>
                          </div>
                        )}
