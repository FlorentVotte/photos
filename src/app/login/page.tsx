      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-3">
            <label
              htmlFor="password"
              className="font-sans text-label uppercase text-text-muted"
            >
              Password
            </label>
            <input
          ...
          <button
            ...
            className="group/cta mt-2 inline-flex items-center gap-3 self-start font-sans text-label uppercase text-text-muted hover:text-foreground transition-colors disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        <p className="mt-16 text-center font-sans text-label uppercase text-text-muted/50">
