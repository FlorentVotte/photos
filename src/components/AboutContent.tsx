            ...
            <section className="flex flex-col gap-10">
              ...
              <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
                {gear.cameras.length > 0 && (
                  <div className="flex flex-col gap-6">
                    <h3 className="font-sans text-[11px] uppercase tracking-[0.32em] text-text-muted">
                      {t("about", "cameras")}
                    </h3>
                    <ul className="flex flex-col divide-y divide-surface-border/60">
                      {gear.cameras.map((camera) => (
                        ...
                        >
                          ...
                          <span className="font-sans text-[11px] uppercase tracking-[0.2em] tabular-nums text-text-muted">
                    ...
                    <ul className="flex flex-col divide-y divide-surface-border/60">
                      {gear.lenses.slice(0, 5).map((lens) => (
                        ...
                        >
                          ...
                          <span className="whitespace-nowrap font-sans text-[11px] uppercase tracking-[0.2em] tabular-nums text-text-muted">
