      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="flex flex-col gap-2">
          <div className="flex items-baseline gap-4">
            ...
            <span className={`font-sans text-label uppercase ${getStatusColor()}`}>
              {getStatusLabel()}
            </span>
          </div>
        ...
        {status?.connected ? (
          ...
          <a
            href="/api/auth/adobe"
            className="group/cta inline-flex items-center gap-3 self-start font-sans text-label uppercase text-foreground hover:text-foreground transition-colors"
