    ...
    <div className="flex items-center justify-between gap-4 border-b border-surface-border/60 py-5 last:border-b-0">
      <div className="flex min-w-0 flex-1 flex-col gap-1.5">
        <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
          ...
          {gallery.type === "private" && (
            <span className="font-sans text-micro uppercase text-blue-400/80">
              Private
            </span>
          )}
        </div>
      ...
      <div className="flex shrink-0 items-center gap-6">
        <button
          ...
          className={`font-sans text-label uppercase transition-colors disabled:opacity-50 ${
            syncing
        ...
        <button
          ...
          disabled={disabled}
          className="font-sans text-label uppercase text-text-muted hover:text-red-400 transition-colors disabled:opacity-50"
