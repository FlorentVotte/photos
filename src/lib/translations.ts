...
export const translations = {
  ...
  map: {
    ...
    mappedPhotos: { en: "Mapped photos", fr: "Photos cartographiées" },
    loadMore: { en: "Load more", fr: "Afficher plus" },
    loadingMap: { en: "Loading map", fr: "Chargement de la carte" },
    loadingGlobe: { en: "Loading globe", fr: "Chargement du globe" },
    basemapUnavailable: {
      en: "The map background could not be loaded. Photo markers remain available.",
      fr: "Le fond de carte n’a pas pu être chargé. Les marqueurs photo restent disponibles.",
    },
    albumMarker: { en: "Photo album", fr: "Album photo" },
